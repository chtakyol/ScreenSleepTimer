package com.ToolCompany.screentimer.service
...
import com.ToolCompany.screentimer.utils.NotificationManager
...
class SleepTimerForegroundService : Service() {
    companion object {
        ...
        const val ACTION_COUNTDOWN_UPDATE = "com.ToolCompany.screentimer.COUNTDOWN_UPDATE"
        const val ACTION_EXTEND_TIME = "com.ToolCompany.screentimer.EXTEND_TIME"
        const val EXTRA_EXTEND_TIME = "extend_time"
        const val PERMISSION_RECEIVE_COUNTDOWN = "com.ToolCompany.screentimer.permission.RECEIVE_COUNTDOWN"
        const val ACTION_STOP = "com.ToolCompany.screentimer.permission.STOP"
    }
